...
ifneq ($(wildcard $(SELF_DIR)/../../.git/modules/panda_jungle/HEAD),)
obj/gitversion.h: $(SELF_DIR)/../VERSION $(SELF_DIR)/../../.git/modules/panda_jungle/HEAD $(SELF_DIR)/../../.git/modules/panda_jungle/index
	echo "const uint8_t gitversion[] = \"$(shell cat $(SELF_DIR)/../VERSION)-$(BUILDER)-$(shell git rev-parse --short=8 HEAD)-$(BUILD_TYPE)\";" > $@
else
